...
def create_architecture_diagram():
    ...
    components = {
        ...
        'News Fetcher': (0.1, 0.65, 0.15, 0.1),
        'Sentiment Analyzer': (0.3, 0.65, 0.15, 0.1),
    ...
    strategies = {
        ...
        'Sentiment Strategy': (0.14, 0.21, 0.12, 0.06)
    }
    ...
    arrows = [
        ...
        ('Data Sources', 'News Fetcher'),
        ('News Fetcher', 'Sentiment Analyzer'),
        ('Sentiment Analyzer', 'Data Processor'),
    ...
    # Add connection from Sentiment Analyzer to Sentiment Strategy
    sentiment_analyzer_box = components['Sentiment Analyzer']
    sentiment_strategy_box = strategies['Sentiment Strategy']

    # Calculate start and end points
    start_point = (sentiment_analyzer_box[0] + sentiment_analyzer_box[2]/2, 
                  sentiment_analyzer_box[1])
    end_point = (sentiment_strategy_box[0] + sentiment_strategy_box[2]/2, 
                sentiment_strategy_box[1] + sentiment_strategy_box[3])
