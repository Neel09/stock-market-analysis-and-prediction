...
class DataFetcher:
    ...
    def __init__(self, config_path=None):
        ...
        self.data_dir = os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 
                                        'data'))
    ...
    def fetch_data(self, symbol, start_date=None, end_date=None, period=None, interval=None):
        """
        ...
        if self.is_indian_market(symbol) and self.nifty_fetcher is not None:
            ...
            return self.nifty_fetcher.fetch_nifty_data(period=period, index_name=nifty_symbol)
